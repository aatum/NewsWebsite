...
//creating const for economy news
const EconomyNewsList = () => {
...
//fetching news from the API
  const getNews = () => {
    fetch(`https://newsapi.org/v2/top-headlines?country=gb&category=business&language=en&apiKey=${API_KEY}`)
...
export default EconomyNewsList;
